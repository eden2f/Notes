...
> [Spring Data Elasticsearch - Reference Documentation](https://docs.spring.io/spring-data/elasticsearch/docs/current/reference/html/#elasticsearch.query-methods.at-query)
[ElasticSearch : Query and filter context](https://www.elastic.co/guide/en/elasticsearch/reference/6.0/query-filter-context.html#query-filter-context)

[示例项目Github代码仓库](https://github.com/eden2f/weixin-mp-saas) : [https://github.com/eden2f/weixin-mp-saas](https://github.com/eden2f/weixin-mp-saas)
## Maven依赖
```xml
<dependency>
...
public class ElasticsearchConfig {
    ...
    public RestHighLevelClient elasticsearchClient() {
        ClientConfiguration configuration = ClientConfiguration.builder()
                ...
                .withSocketTimeout(Duration.ofSeconds(3)).withBasicAuth(username, password)
                //.useSsl()
